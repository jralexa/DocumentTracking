        ...
        <div class="mx-auto max-w-5xl sm:px-6 lg:px-8">
            <section class="rounded-xl border border-slate-200 bg-white shadow-sm">
                <form
                    ...
                    x-data="{ quickMode: @js(old('quick_mode', '1') === '1'), isReturnable: @js((bool) old('is_returnable')) }"
                ...
                >
                    ...
                    <section class="rounded-lg border border-slate-200 bg-slate-50/40 p-4">
                        ...
                        <div class="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
                            <div>
                                ...
                                <select id="owner_type" name="owner_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                    ...
                    <div class="sticky bottom-0 z-10 -mx-4 border-t border-slate-200 bg-white px-4 py-3 sm:-mx-5 sm:px-5">
